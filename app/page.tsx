  ...
  return (
    <div className="grid grid-rows-[1fr] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-8 items-center">
        {["Profile", "Positions", "Education", "Certifications", "Skills"].map(
          (sectionKey) => {
            ...
            switch (sectionKey) {
                    ...
                    <div className="flex flex-col items-center gap-4 sm:flex-row sm:items-start">
                      {profile["Image URL"] && (
                        <img
                          ...
                          alt={`${profile["First Name"]} ${profile["Last Name"]}`}
              ...
              case "Positions": {
                return (
                  <section
                    ...
                    className="w-full max-w-4xl p-6 border rounded-lg shadow-lg bg-gray-100"
                  >
                    {/* Updated section title with icon */}
                    <h2 className="text-3xl font-bold mb-6 text-gray-800 flex items-center gap-2">
                      <span className="material-icons">work</span> Work Experience
                    </h2>
                    <ul className="space-y-4">
                      {data[sectionKey].map((position: any, index: number) => (
                        <li key={index} className="border-b pb-4">
                          ...
                          <p className="text-sm text-gray-500">{`${position["Started On"]} - ${
              ...
              case "Certifications": {
                return (
                  ...
                  >
                    <h2 className="text-3xl font-bold mb-6 text-gray-800 flex items-center gap-2">
                      <span className="material-icons">verified</span> Certifications
                    </h2>
                    <ul className="space-y-4">
                      {data[sectionKey].map(
